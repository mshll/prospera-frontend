  ...
  return (
    <div className='flex gap-3 rounded-md border border-border bg-secondary p-4'>
      ...
      <div className='flex w-full flex-col justify-center gap-2'>
        <div className='text-lg font-semibold'>Luxury Apartment</div>
        <div className='flex w-full justify-between gap-1 pe-3'>
          <div className='flex flex-col'>
            <div className='text-[.6rem] uppercase text-muted-foreground'>Value (KWD)</div>
            <div className='justify-between font-semibold text-primary'>51,000</div>
          </div>
          <div className='border-l border-border'></div>
          <div className='flex flex-col justify-between'>
            <div className='text-[.6rem] uppercase text-muted-foreground'>Shares</div>
            <div className='font-semibold text-primary'>300</div>
          </div>
          <div className='border-l border-border'></div>
          <div className='flex flex-col justify-between'>
